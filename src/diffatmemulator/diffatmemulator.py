# differentiable atmospheric transparency Emulator
#
...
class DiffAtmEmulator(DiffAtmPressEmulator):
    """
...
def run(obs_str, pressure):
    print("===========================================================================")
    print(f"Differentiable Atmospheric Emulator for {obs_str} observatory and pressure = {pressure:.2f} hPa") 
    print("===========================================================================")
